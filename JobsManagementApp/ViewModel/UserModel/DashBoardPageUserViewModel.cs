...
{
    public class DashBoardPageUserViewModel : BaseViewModel
    {
        ...
        public DashBoardPageUserViewModel(UsersDTO a)
        {
            ...
            OpenAddJobWindowCM = new RelayCommand<object>((p) => { return true; }, async (p) =>
            {
                ...
                JobAddViewModel vm = new JobAddViewModel(user, JobsPie, JobsLine, Jobs, this);
        ...
        public async Task Load()
        {
            try
            {
                ...
                Jobs = new ObservableCollection<JobsDTO>(await JobService.Ins.GetAllJobByAssigneeID("USER", (int)user.id));
