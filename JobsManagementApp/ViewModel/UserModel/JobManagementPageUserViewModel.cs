...
{
    public class JobManagementPageUserViewModel : BaseViewModel
    {
        ...
        public JobManagementPageUserViewModel(UsersDTO a, int assignee_id)
        {
            user = a;
            ...
            OpenAddJobWindowCM = new RelayCommand<object>((p) => { return assignee != null; }, async (p) =>
            {
                ...
                JobAddViewModel vm = new JobAddViewModel(user, this);
            ...
            {
                JobDetailViewModel vm = new JobDetailViewModel(user, SelectedItem);
        ...
        public async Task Load2()
        {
            ...
            try
            {
                ...
                Jobs = new ObservableCollection<JobsDTO>(await JobService.Ins.GetAllJobByUserId("USER", (int)assignee.id));
