...
CREATE TABLE QUESTION(
		NAME    			VARCHAR(100)   		,
		CONSTRAINT pk_QUESTION PRIMARY KEY(NAME)
);
INSERT INTO QUESTION(NAME) VALUES('WHAT IS THE NAME OF YOUR FIRST PET?');
INSERT INTO QUESTION(NAME) VALUES('WHAT WAS YOUR FIRST MOTOBILE?');
INSERT INTO QUESTION(NAME) VALUES('WHAT IS THE NAME OF THE TOWN WHERE YOU WERE BORN?');
INSERT INTO QUESTION(NAME) VALUES('WHAT WAS YOUR CHILDHOOD NICKNAME?');
INSERT INTO QUESTION(NAME) VALUES('WHAT YOUR NAME?"');
...
INSERT INTO ADMIN(NAME, GENDER, D_O_B, PHONE, ADDRESS,  NATIONALITY,ORGANIZATION, POSITION, AVATAR, EMAIL, USERNAME, PASS, QUESTION, ANSWER, TOTAL_WORKING_HOUR) 
	VALUES('HUYNH HUU BAO KHOA', 'NAM', '14-11-2001', '0372753988', '2, TAN AN, THI TRAN CAI TAC, HAU GIANG', 
	'VIET NAM','DAI HOC CAN THO', 'HIEU TRUONG', 'C:/xampp/htdocs/bank/images/avatar/1.jpg','ADMIN@GMAIL.COM', 'ADMIN', 'ADMIN',"WHAT YOUR NAME?",'KHOA',0);
...
INSERT INTO USER(NAME, GENDER, D_O_B, PHONE, ADDRESS, NATIONALITY, ORGANIZATION, POSITION, AVATAR, EMAIL, USERNAME, PASS, QUESTION, ANSWER, TOTAL_WORKING_HOUR) 
	VALUES('HUYNH HUU BAO KHOA', 'NAM', '14-11-2001', '0372753988', '2, TAN AN, THI TRAN CAI TAC, HAU GIANG', 
		 'VIET NAM', 'DAI HOC CAN THO', 'HIEU TRUONG', 'C:/xampp/htdocs/bank/images/avatar/1.jpg','USER1@GMAIL.COM', 'USER1', 'USER1',"WHAT YOUR NAME?",'KHOA',243);
INSERT INTO USER(NAME, GENDER, D_O_B, PHONE, ADDRESS, NATIONALITY, ORGANIZATION, POSITION, AVATAR, EMAIL, USERNAME, PASS, QUESTION, ANSWER, TOTAL_WORKING_HOUR) 
	VALUES('HUYNH HUU BAO KHOA', 'NAM', '14-11-2001', '0372753988', '2, TAN AN, THI TRAN CAI TAC, HAU GIANG', 
		 'VIET NAM', 'DAI HOC CAN THO', 'HIEU PHO', 'C:/xampp/htdocs/bank/images/avatar/1.jpg','USER2@GMAIL.COM', 'USER2', 'USER2',"WHAT YOUR NAME?",'KHOA',0);
INSERT INTO USER(NAME, GENDER, D_O_B, PHONE, ADDRESS, NATIONALITY, ORGANIZATION, POSITION, AVATAR, EMAIL, USERNAME, PASS, QUESTION, ANSWER, TOTAL_WORKING_HOUR) 
	VALUES('HUYNH HUU BAO KHOA', 'NAM', '14-11-2001', '0372753988', '2, TAN AN, THI TRAN CAI TAC, HAU GIANG', 
		 'VIET NAM', 'KHOA CONG NGHE THONG TIN VA TRUYEN THONG', 'TRUONG KHOA', 'C:/xampp/htdocs/bank/images/avatar/1.jpg','USER3@GMAIL.COM', 'USER3', 'USER3',"WHAT YOUR NAME?",'KHOA',0);
INSERT INTO USER(NAME, GENDER, D_O_B, PHONE, ADDRESS, NATIONALITY, ORGANIZATION, POSITION, AVATAR, EMAIL, USERNAME, PASS, QUESTION, ANSWER, TOTAL_WORKING_HOUR) 
	VALUES('HUYNH HUU BAO KHOA', 'NAM', '14-11-2001', '0372753988', '2, TAN AN, THI TRAN CAI TAC, HAU GIANG', 
		 'VIET NAM', 'KHOA CONG NGHE THONG TIN VA TRUYEN THONG', 'PHO KHOA', 'C:/xampp/htdocs/bank/images/avatar/1.jpg','USER4@GMAIL.COM', 'USER4', 'USER4',"WHAT YOUR NAME?",'KHOA',0);
...
INSERT INTO JOB(DEPENDENCY_ID, DEPENDENCY_NAME, NAME, DESCRIPTION, CATEGORY, START_DATE,
 DUE_DATE, END_DATE, REQUIRED_HOUR, WORKED_HOUR, PERCENT, STAGE,
  ASSIGNOR_ID, ASSIGNOR_TYPE, ASSIGNOR_NAME, ASSIGNEE_ID, ASSIGNEE_TYPE, ASSIGNEE_NAME) 
	VALUES(-1, 'NONE', 'CT209H', 'DAY HOC O PHONG 110 CHO LOP CT209H', 'DAY HOC', '04-11-2022','04-03-2023','NONE',70,34,49,'PENDING',1,'ADMIN','HUYNH HUU BAO KHOA',
	1,'USER','HUYNH HUU BAO KHOA');
INSERT INTO JOB(DEPENDENCY_ID, DEPENDENCY_NAME, NAME, DESCRIPTION, CATEGORY, START_DATE,
 DUE_DATE, END_DATE, REQUIRED_HOUR, WORKED_HOUR, PERCENT, STAGE,
  ASSIGNOR_ID, ASSIGNOR_TYPE, ASSIGNOR_NAME, ASSIGNEE_ID, ASSIGNEE_TYPE, ASSIGNEE_NAME) 
	VALUES(-1, 'NONE', 'LAB05 CT105H', 'HOANG THANH LAB05 MON CT105H', 'DAY HOC','02-11-2022', '04-11-2022', '03-11-2022',2, 1, 100, 'COMPLETE SOON',
  	1, 'ADMIN','HUYNH HUU BAO KHOA', 1, 'USER','HUYNH HUU BAO KHOA');
INSERT INTO JOB(DEPENDENCY_ID, DEPENDENCY_NAME, NAME, DESCRIPTION, CATEGORY, START_DATE,
 DUE_DATE, END_DATE, REQUIRED_HOUR, WORKED_HOUR, PERCENT, STAGE,
  ASSIGNOR_ID, ASSIGNOR_TYPE, ASSIGNOR_NAME, ASSIGNEE_ID, ASSIGNEE_TYPE, ASSIGNEE_NAME) 
	VALUES(-1, 'NONE', 'NLCN', 'CODE PROJECT QUAN LY CONG VIEC NLCN', 'CA NHAN', '10-07-2022', '15-12-2022', 'NONE', 300, 200, 80, 'PENDING',
  	1, 'ADMIN', 'HUYNH HUU BAO KHOA', 1, 'USER', 'HUYNH HUU BAO KHOA');
INSERT INTO JOB(DEPENDENCY_ID, DEPENDENCY_NAME, NAME, DESCRIPTION, CATEGORY, START_DATE,
 DUE_DATE, END_DATE, REQUIRED_HOUR, WORKED_HOUR, PERCENT, STAGE,
  ASSIGNOR_ID, ASSIGNOR_TYPE, ASSIGNOR_NAME, ASSIGNEE_ID, ASSIGNEE_TYPE, ASSIGNEE_NAME) 
	VALUES(3, 'NLCN', 'BACKEND NLCN', 'THIET KET CSDL VA SERVER', 'CA NHAN', '12-07-2022',
 '15-07-2022', '13-07-2022', 8, 6, 100, 'COMPLETE SOON',
  1, 'ADMIN', 'HUYNH HUU BAO KHOA', 1, 'USER', 'HUYNH HUU BAO KHOA');

INSERT INTO JOB(DEPENDENCY_ID, DEPENDENCY_NAME, NAME, DESCRIPTION, CATEGORY, START_DATE,
 DUE_DATE, END_DATE, REQUIRED_HOUR, WORKED_HOUR, PERCENT, STAGE,
  ASSIGNOR_ID, ASSIGNOR_TYPE, ASSIGNOR_NAME, ASSIGNEE_ID, ASSIGNEE_TYPE, ASSIGNEE_NAME) 
	VALUES(-1, 'NONE', 'LAO DONG SAN TRUONG', 'DON VE SINH SAN TRUONG KHOA CNTT', 'XA HOI', '04-11-2022', '04-11-2022', '05-11-2022', 2, 2, 100, 'COMPLETE LATE',
  	1, 'USER', 'HUYNH HUU BAO KHOA', 1, 'USER', 'HUYNH HUU BAO KHOA');
INSERT INTO JOB(DEPENDENCY_ID, DEPENDENCY_NAME, NAME, DESCRIPTION, CATEGORY, START_DATE,
 DUE_DATE, END_DATE, REQUIRED_HOUR, WORKED_HOUR, PERCENT, STAGE,
  ASSIGNOR_ID, ASSIGNOR_TYPE, ASSIGNOR_NAME, ASSIGNEE_ID, ASSIGNEE_TYPE, ASSIGNEE_NAME) 
	VALUES(-1, 'NONE', 'LAO DONG KHOA KINH TE', 'DON VE SINH SANH KHOA KINH TE', 'XA HOI', '14-11-2022', '14-11-2022', 'NONE', 2, 0, 0, 'LATE',
  	1, 'USER', 'HUYNH HUU BAO KHOA', 1, 'USER', 'HUYNH HUU BAO KHOA');
INSERT INTO JOB(DEPENDENCY_ID, DEPENDENCY_NAME, NAME, DESCRIPTION, CATEGORY, START_DATE,
 DUE_DATE, END_DATE, REQUIRED_HOUR, WORKED_HOUR, PERCENT, STAGE,
  ASSIGNOR_ID, ASSIGNOR_TYPE, ASSIGNOR_NAME, ASSIGNEE_ID, ASSIGNEE_TYPE, ASSIGNEE_NAME) 
	VALUES(-1, 'NONE', 'HO TRO NGUOI NGHEO', 'THAM GIA HO TRO NGUOI NGHEO HAU GIANG, CHAU THANH', 'XA HOI', '20-01-2023', '25-01-2023', 'NONE', 20, 0, 0, 'WAITING',
  	1, 'USER', 'HUYNH HUU BAO KHOA', 1, 'USER', 'HUYNH HUU BAO KHOA');
CREATE TABLE REPORT(
		ID           		INT 	     		AUTO_INCREMENT,
		JOB_ID				INT					,
...
INSERT INTO REPORT(JOB_ID, JOB_NAME, TILE, DESCRIPTION, CREATED_TIME) VALUES(1, 'CT209H', 'BAO CAO 1 CT209H', 'DA HOAN THANH 30% CONG VIEC','' )
